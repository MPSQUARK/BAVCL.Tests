...
public class ArangeTests
{
    ...
    {
        var result = Vector.Arange(_gpu, 0, 10, 0.5f, cache: false);

        var expected = new float[] {
            0.5f, 1.0f, 1.5f, 2.0f, 2.5f, 3.0f, 3.5f, 4.0f, 4.5f, 5.0f,
            5.5f, 6.0f, 6.5f, 7.0f, 7.5f, 8.0f, 8.5f, 9.0f, 9.5f
        };
    ...
    {
        var result = Vector.Arange(_gpu, 0, -10, -1f, cache: false);
        ...
        var result2 = Vector.Arange(_gpu, 0, -10, 1f, cache: false);
